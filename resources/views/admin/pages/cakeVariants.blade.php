                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="createVariant" action="{{ route('variants.store') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input class="form-control form-control-lg" type="text" placeholder="Variant Name" aria-label="Variant Name" name="variant_name">
                                                </div>
                                            </div>
                                        </form>
                                        {{-- ******** --}}
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="updateVariant" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input id="variantName" class="form-control form-control-lg" type="text" placeholder="Variant Name" aria-label="Variant Name" name="variant_name">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
