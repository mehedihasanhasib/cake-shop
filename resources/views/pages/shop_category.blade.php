...
@section('content')
    ...
    <section class="shop spad">
        <div class="container">
            ...
            @include('components.filter_shop', ['variants' => $variants, 'selected_variant' => $variant->variant_name])

            <div class="row">
                @foreach ($filtered_cakes as $key => $cake)
            ...
            {{-- {{ $filtered_cakes->links('vendor.pagination.shop-pagination') }} --}}
        </div>
    </section>
    <!-- Shop Section End -->
@endsection
